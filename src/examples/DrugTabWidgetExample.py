...
class DetachableTabWidget(QtWidgets.QTabWidget):
    ...
    @QtCore.pyqtSlot(QtCore.QVariant, int, QtCore.QPoint)
    ...
    class DetachedTab(QtWidgets.QMainWindow):
        onCloseSignal = pyqtSignal(QtWidgets.QWidget, QtCore.QVariant, QtGui.QIcon)
        onDropSignal = pyqtSignal(QtCore.QVariant, QtCore.QPoint)
    ...
    class TabBar(QtWidgets.QTabBar):
        ...
        detachedTabDropSignal = pyqtSignal(QtCore.QVariant, int, QtCore.QPoint)
